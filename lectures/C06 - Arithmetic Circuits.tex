...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}[>=stealth, scale=0.92, transform shape]
      ...
      % input a rail
      \draw[thick] (x1.input 1) -- ++(-0.6,0) coordinate (adot);
      \draw[thick] (adot) -- ++(-0.6,0) node[left, smallgraytext] {\ttab{a}};
      \draw[thick] (adot) |- (a1.input 1);
      \fill (adot) circle (1.3pt);
      % input b rail
      \draw[thick] (x1.input 2) -- ++(-0.2,0) coordinate (bdot);
      \draw[thick] (bdot) -- ++(-1.0,0) node[left, smallgraytext] {\ttab{b}};
      \draw[thick] (bdot) |- (a1.input 2);
      \fill (bdot) circle (1.3pt);
      % p and g
      \draw[thick] (x1.output) -- ++(1.3,0) coordinate (p) node[above, smallgraytext] {\ttab{p}};
      \draw[thick] (a1.output) -- ++(3.6,0) coordinate (g);
      % second half adder
      ...
      \draw[thick] (1.55,-1.1) |- (x2.input 2);
