...
\begin{frame}
  To negate a number, invert every bit and add one. The result represents its negative.\\[5mm]
  \begin{center}
    \renewcommand{\arraystretch}{1.5}
    \begin{tabular}{r@{\hspace{6mm}}l}
      \ttab{0101}          & \graytext{the value \ttab{5}} \\
      \ttab{1010}          & \graytext{invert every bit} \\
      \ttab{1011}          & \graytext{add one, giving \ttab{-5}} \\
    \end{tabular}
  \end{center}
\end{frame}
