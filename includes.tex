...
\definecolor{mytransparent}{RGBA}{250,150,24,0.5}
\definecolor{myred}{HTML}{ED5565}
\definecolor{myorange}{HTML}{FC6E51}
\definecolor{myyellow}{HTML}{FFCE54}
\definecolor{mygreen}{HTML}{A0D469}
\definecolor{myteal}{HTML}{48CFAD}
\definecolor{mycyan}{HTML}{4FC1E9}
\definecolor{myblue}{HTML}{5D9CEC}
\definecolor{mypurple}{HTML}{AC92EC}
\definecolor{mypink}{HTML}{EC87C0}
\definecolor{green1}{HTML}{C0C490}
\definecolor{blue1}{HTML}{CADCD7}
\definecolor{green2}{HTML}{B7C6AB}
\definecolor{gray1}{HTML}{B3B1A5}
...
\usetikzlibrary{
  ...
  automata, chains, decorations.pathreplacing, calligraphy, backgrounds,
...
\tikzset{
  ...
  right triangle/.style={
    draw, thick, fill=myyellow,
    shape border rotate=0,
    shape=isosceles triangle,
    isosceles triangle apex angle=90,
    minimum size=1mm, inner sep=0pt, anchor=center
  },
  ...
  arrow inside/.style 2 args={
    set arrow inside={#1},
    postaction={decorate, decoration={markings, Mark/.list={#2}}}
  }
}
